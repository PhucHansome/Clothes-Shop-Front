  ...
  const handleEditCustomer = () => {
    try {
      const doCreateCustomerInfo = async () => {
        ...
        let userAddCustomerInfoRes = await authService.getUserByUserName(
          localStorage.getItem("username")
        );
        customerInfor.user = userAddCustomerInfoRes.data;
        console.log(customerInfor.user);
        let customerRest = await customerInfoService.doEditCustomerInfo(
                ...
                <div className="row">
                  <div className="col-6">
                    ...
                    <input
                      ...
                      type="text"
                      id="form12"
                      value={customerInfo.customerInfor.fullName}
                  ...
                  <div className="col-6">
                    ...
                    <input
                      ...
                      type="text"
                      id="form12"
                      value={customerInfo.customerInfor.phone}
                      className="form-control"
                    />
                  </div>
                  <div className="col-6">
                  ...
                  <div className="col-6">
                    ...
                    <input
                      ...
                      name="address"
                      value={customerInfo.customerInfor.locationRegion.address}
                      type="text"
                      id="form12"
                      className="form-control"
                    />
